        ...
        for (let index = 0; index < e.target.files.length; index++) {
          ...
          if (extensions && (!ext || !extensions.includes(`.${ext}`))) {
            toast({
              ...toastErrorMessage,
              description:
                "Invalid thumbnail format. Please upload an image in valid format.",
            });
            return false;
          }
          if (file && file.size > maxSize) {
            toast({
              ...toastErrorMessage,
              description:
                "Thumbnail size exceeds the limit of 5MB. Please upload a smaller image.",
            });
            return false;
          }
        }
      ...
      <>
        ...
        >
          ...
          <label htmlFor={id} className="cursor-pointer text-sm">
            <div>
              <b>Click here to select thumbnail</b>
            </div>
            {!!extensions && (
